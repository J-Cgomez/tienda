(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@ng-util/util'), require('@ng-util/lazy'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-tinymce', ['exports', '@angular/core', '@angular/forms', '@ng-util/util', '@ng-util/lazy', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-tinymce'] = {}, global.ng.core, global.ng.forms, global.util, global.lazy, global.ng.common));
}(this, (function (exports, core, forms, util, lazy, common) { 'use strict';
